 ...
 * representing On/Off actuator. Uses Boolean as value data type. Provides methods for storing, generating and saving value.
...
public class OnOffActuatorValue extends AbstractValue<Boolean> implements HasBooleanRandom {
    ...
    /**
     * Creates and initializes new instance of On/Off actuator from given information as parameter.
