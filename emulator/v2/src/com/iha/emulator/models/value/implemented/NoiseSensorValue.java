 ...
 * representing Noise intensity sensor. Uses Double as value data type. Provides methods for storing, generating and saving value.
...
public class NoiseSensorValue extends AbstractValue<Double> implements HasNormalDistribution,HasLinearDistribution {
    ...
    /**
     * Creates and initializes new instance of Noise intensity sensor from given information as parameter.
