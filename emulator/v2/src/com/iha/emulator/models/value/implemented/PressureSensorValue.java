 ...
 * representing Pressure sensor. Uses Integer as value data type. Provides methods for storing, generating and saving value.
 * For generating new values uses both Normal and Linear distribution.
 *
 * @author <a href="mailto:xsutov00@stud.fit.vutbr.cz">Filip Sutovsky</a>
 */
public class PressureSensorValue extends AbstractValue<Integer> implements HasNormalDistribution,HasLinearDistribution{
    /** default value */
    private static final int DEFAULT_VALUE = 995;
    /** default distribution maximal value */
    private static final double DEFAULT_MAX = 1080;
    /** default distribution minimal value */
    private static final double DEFAULT_MIN = 930;
    /** default normal distribution deviation */
    private static final double DEFAULT_NORMAL_DEV = 5;
    /** default normal distribution average */
    private static final double DEFAULT_NORMAL_AVG = 995;
    ...
    /**
     * Creates and initializes new instance of Pressure sensor from given information as parameter.
     ...
     */
    public PressureSensorValue(String name, String type, int offset, String unit, boolean generateValue, boolean storeHistory, Random generator, Long generatorSeed) {
        super(Type.SENSOR_PRESSURE,name,type,offset,unit,generateValue,storeHistory,generator,generatorSeed);
        ...
        switch (getGeneratorType()){
            case NORMAL_DISTRIBUTION:
                if(devProperty() == null || avgProperty() == null || maxProperty() == null || minProperty() == null){
                    throw new IllegalArgumentException("Pressure generator doesn't have variables needed to generate new value (Dev,Avg,Max,Min)");
                }
            ...
            case LINEAR_DISTRIBUTION:
                if(stepProperty() == null || maxProperty() == null || minProperty() == null){
                    throw new IllegalArgumentException("Pressure generator doesn't have variables needed to generate new value (Step,Max,Min)");
                }
