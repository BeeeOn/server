 ...
 * representing Temperature sensor. Uses Double as value data type. Provides methods for storing, generating and saving value.
...
public class TemperatureSensorValue extends AbstractValue<Double> implements HasNormalDistribution,HasLinearDistribution {
    ...
    /**
     * Creates and initializes new instance of Temperature sensor from given information as parameter.
