 ...
 * representing Boiler Mode actuator. Uses Integer as value data type. Provides methods for storing, generating and saving value.
 * For generating new values uses both Normal and Linear distribution. All possible value provided by
 * {@link com.iha.emulator.models.value.implemented.BoilerModeActuatorValue.BoilerOperationMode} enum.
 *
...
public class BoilerModeActuatorValue extends AbstractValue<Integer> implements HasNormalDistribution,HasLinearDistribution,VPTRegulatorValue {
    ...
    /**
     * Creates and initializes new instance of Boiler Mode actuator from given information as parameter.
     ...
     */
    @Override
    public Integer nextValue() throws IllegalArgumentException{
