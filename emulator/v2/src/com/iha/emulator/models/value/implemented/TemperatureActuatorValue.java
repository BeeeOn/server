 ...
 * representing Temperature actuator. Uses Double as value data type. Provides methods for storing, generating and saving value.
 * For generating new values uses both Normal and Linear distribution.
 *
 * @author <a href="mailto:xsutov00@stud.fit.vutbr.cz">Filip Sutovsky</a>
 */
public class TemperatureActuatorValue extends AbstractValue<Double> implements HasNormalDistribution,HasLinearDistribution {
    /** default value */
    ...
    /**
     * Creates and initializes new instance of Temperature actuator from given information as parameter.
     ...
     */
    public TemperatureActuatorValue(String name, String type, int offset, String unit, boolean generateValue, boolean storeHistory, Random generator, Long generatorSeed) {
        super(Type.ACTUATOR_TEMPERATURE,name,type,offset,unit,generateValue,storeHistory,generator,generatorSeed);
