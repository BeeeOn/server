...
BEEEON_OBJECT_PROPERTY("scanDuration", &GatewayXmlHandlerResolver::setScanDuration)
BEEEON_OBJECT_PROPERTY("gatewayService", &GatewayXmlHandlerResolver::setGatewayService)
BEEEON_OBJECT_PROPERTY("sessionManager", &GatewayXmlHandlerResolver::setSessionManager)
BEEEON_OBJECT_PROPERTY("timeZoneProvider", &GatewayXmlHandlerResolver::setTimeZoneProvider)
