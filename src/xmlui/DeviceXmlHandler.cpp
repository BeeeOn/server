...
BEEEON_OBJECT_PROPERTY("deviceService", &DeviceXmlHandlerResolver::setDeviceService)
BEEEON_OBJECT_PROPERTY("sessionManager", &DeviceXmlHandlerResolver::setSessionManager)
BEEEON_OBJECT_PROPERTY("cryptoConfig", &DeviceXmlHandlerResolver::setCryptoConfig)
