...
BEEEON_OBJECT_PROPERTY("identityService", &ProfileXmlHandlerResolver::setIdentityService)
BEEEON_OBJECT_PROPERTY("sessionManager", &ProfileXmlHandlerResolver::setSessionManager)
