...
BEEEON_OBJECT_PROPERTY("host", &SocketRPCConnector::setHost)
BEEEON_OBJECT_PROPERTY("port", &SocketRPCConnector::setPort)
BEEEON_OBJECT_PROPERTY("receiveTimeout", &SocketRPCConnector::setReceiveTimeout)
