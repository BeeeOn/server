...
BEEEON_OBJECT_PROPERTY("daoManager", &PocoSQLGatewayStatusDao::setDaoManager)
BEEEON_OBJECT_PROPERTY("transactionManager", &PocoSQLGatewayStatusDao::setTransactionManager)
BEEEON_OBJECT_PROPERTY("sqlLoader", &PocoSQLGatewayStatusDao::setQueryLoader)
BEEEON_OBJECT_PROPERTY("profiler", &PocoSQLGatewayStatusDao::setQueryProfiler)
