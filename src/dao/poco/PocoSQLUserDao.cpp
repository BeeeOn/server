...
BEEEON_OBJECT_PROPERTY("daoManager", &PocoSQLUserDao::setDaoManager)
BEEEON_OBJECT_PROPERTY("transactionManager", &PocoSQLUserDao::setTransactionManager)
BEEEON_OBJECT_PROPERTY("localeManager", &PocoSQLUserDao::setLocaleManager)
BEEEON_OBJECT_PROPERTY("sqlLoader", &PocoSQLUserDao::setQueryLoader)
BEEEON_OBJECT_PROPERTY("profiler", &PocoSQLUserDao::setQueryProfiler)
BEEEON_OBJECT_HOOK("done", &PocoSQLUserDao::loadQueries)
BEEEON_OBJECT_HOOK("cleanup", &PocoSQLUserDao::clearQueries)
