...
BEEEON_OBJECT_PROPERTY("daoManager", &PocoSQLDevicePropertyDao::setDaoManager)
BEEEON_OBJECT_PROPERTY("transactionManager", &PocoSQLDevicePropertyDao::setTransactionManager)
BEEEON_OBJECT_PROPERTY("sqlLoader", &PocoSQLDevicePropertyDao::setQueryLoader)
BEEEON_OBJECT_PROPERTY("profiler", &PocoSQLDevicePropertyDao::setQueryProfiler)
