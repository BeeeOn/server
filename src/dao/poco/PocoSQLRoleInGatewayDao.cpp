...
BEEEON_OBJECT_PROPERTY("daoManager", &PocoSQLRoleInGatewayDao::setDaoManager)
BEEEON_OBJECT_PROPERTY("transactionManager", &PocoSQLRoleInGatewayDao::setTransactionManager)
BEEEON_OBJECT_PROPERTY("sqlLoader", &PocoSQLRoleInGatewayDao::setQueryLoader)
BEEEON_OBJECT_PROPERTY("profiler", &PocoSQLRoleInGatewayDao::setQueryProfiler)
BEEEON_OBJECT_PROPERTY("timeZoneProvider", &PocoSQLRoleInGatewayDao::setTimeZoneProvider)
BEEEON_OBJECT_HOOK("done", &PocoSQLRoleInGatewayDao::loadQueries)
BEEEON_OBJECT_HOOK("cleanup", &PocoSQLRoleInGatewayDao::clearQueries)
