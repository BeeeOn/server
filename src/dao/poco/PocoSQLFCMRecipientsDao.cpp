...
BEEEON_OBJECT_PROPERTY("daoManager", &PocoSQLFCMRecipientsDao::setDaoManager)
BEEEON_OBJECT_PROPERTY("transactionManager", &PocoSQLFCMRecipientsDao::setTransactionManager)
BEEEON_OBJECT_PROPERTY("sqlLoader", &PocoSQLFCMRecipientsDao::setQueryLoader)
BEEEON_OBJECT_PROPERTY("profiler", &PocoSQLFCMRecipientsDao::setQueryProfiler)
