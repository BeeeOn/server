...
BEEEON_OBJECT_PROPERTY("deviceInfoProvider", &PocoSQLDeviceDao::setDeviceInfoProvider)
BEEEON_OBJECT_PROPERTY("daoManager", &PocoSQLDeviceDao::setDaoManager)
BEEEON_OBJECT_PROPERTY("transactionManager", &PocoSQLDeviceDao::setTransactionManager)
BEEEON_OBJECT_PROPERTY("sqlLoader", &PocoSQLDeviceDao::setQueryLoader)
BEEEON_OBJECT_PROPERTY("profiler", &PocoSQLDeviceDao::setQueryProfiler)
BEEEON_OBJECT_HOOK("done", &PocoSQLDeviceDao::loadQueries)
BEEEON_OBJECT_HOOK("cleanup", &PocoSQLDeviceDao::clearQueries)
