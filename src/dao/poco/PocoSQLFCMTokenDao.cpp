...
BEEEON_OBJECT_PROPERTY("daoManager", &PocoSQLFCMTokenDao::setDaoManager)
BEEEON_OBJECT_PROPERTY("transactionManager", &PocoSQLFCMTokenDao::setTransactionManager)
BEEEON_OBJECT_PROPERTY("sqlLoader", &PocoSQLFCMTokenDao::setQueryLoader)
BEEEON_OBJECT_PROPERTY("profiler", &PocoSQLFCMTokenDao::setQueryProfiler)
BEEEON_OBJECT_HOOK("done", &PocoSQLFCMTokenDao::loadQueries)
BEEEON_OBJECT_HOOK("cleanup", &PocoSQLFCMTokenDao::clearQueries)
