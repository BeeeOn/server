...
BEEEON_OBJECT_PROPERTY("daoManager", &PocoSQLIdentityDao::setDaoManager)
BEEEON_OBJECT_PROPERTY("transactionManager", &PocoSQLIdentityDao::setTransactionManager)
BEEEON_OBJECT_PROPERTY("sqlLoader", &PocoSQLIdentityDao::setQueryLoader)
BEEEON_OBJECT_PROPERTY("profiler", &PocoSQLIdentityDao::setQueryProfiler)
BEEEON_OBJECT_HOOK("done", &PocoSQLIdentityDao::loadQueries)
BEEEON_OBJECT_HOOK("cleanup", &PocoSQLIdentityDao::clearQueries)
