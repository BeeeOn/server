...
BEEEON_OBJECT_PROPERTY("daoManager", &PocoSQLVerifiedIdentityDao::setDaoManager)
BEEEON_OBJECT_PROPERTY("transactionManager", &PocoSQLVerifiedIdentityDao::setTransactionManager)
BEEEON_OBJECT_PROPERTY("localeManager", &PocoSQLVerifiedIdentityDao::setLocaleManager)
BEEEON_OBJECT_PROPERTY("sqlLoader", &PocoSQLVerifiedIdentityDao::setQueryLoader)
BEEEON_OBJECT_PROPERTY("profiler", &PocoSQLVerifiedIdentityDao::setQueryProfiler)
BEEEON_OBJECT_HOOK("done", &PocoSQLVerifiedIdentityDao::loadQueries)
BEEEON_OBJECT_HOOK("cleanup", &PocoSQLVerifiedIdentityDao::clearQueries)
