...
BEEEON_OBJECT_PROPERTY("daoManager", &PocoSQLLocationDao::setDaoManager)
BEEEON_OBJECT_PROPERTY("transactionManager", &PocoSQLLocationDao::setTransactionManager)
BEEEON_OBJECT_PROPERTY("sqlLoader", &PocoSQLLocationDao::setQueryLoader)
BEEEON_OBJECT_PROPERTY("profiler", &PocoSQLLocationDao::setQueryProfiler)
BEEEON_OBJECT_HOOK("done", &PocoSQLLocationDao::loadQueries)
BEEEON_OBJECT_HOOK("cleanup", &PocoSQLLocationDao::clearQueries)
