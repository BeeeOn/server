...
BEEEON_OBJECT_PROPERTY("sslConfig", &FacebookAuthProvider::setSSLConfig)
BEEEON_OBJECT_PROPERTY("clientId", &FacebookAuthProvider::setClientId)
BEEEON_OBJECT_PROPERTY("clientSecret", &FacebookAuthProvider::setClientSecret)
BEEEON_OBJECT_PROPERTY("redirectUri", &FacebookAuthProvider::setRedirectURI)
BEEEON_OBJECT_PROPERTY("id", &FacebookAuthProvider::setID)
