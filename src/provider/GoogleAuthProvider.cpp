...
BEEEON_OBJECT_PROPERTY("clientId", &GoogleAuthProvider::setClientId)
BEEEON_OBJECT_PROPERTY("clientSecret", &GoogleAuthProvider::setClientSecret)
BEEEON_OBJECT_PROPERTY("redirectUri", &GoogleAuthProvider::setRedirectURI)
BEEEON_OBJECT_PROPERTY("id", &GoogleAuthProvider::setID)
BEEEON_OBJECT_PROPERTY("sslConfig", &GoogleAuthProvider::setSSLConfig)
