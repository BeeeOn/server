...
${OBJECTDIR}/src/CombinedTaskInstance.o: src/CombinedTaskInstance.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include/soci -I/usr/include/postgresql -I../lib -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CombinedTaskInstance.o src/CombinedTaskInstance.cpp
...
${OBJECTDIR}/src/DataMessageParser.o: src/DataMessageParser.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include/soci -I/usr/include/postgresql -I../lib -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/DataMessageParser.o src/DataMessageParser.cpp

${OBJECTDIR}/src/DataMessageRegister.o: src/DataMessageRegister.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include/soci -I/usr/include/postgresql -I../lib -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/DataMessageRegister.o src/DataMessageRegister.cpp
...
${OBJECTDIR}/src/GatewayServer.o: src/GatewayServer.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include/soci -I/usr/include/postgresql -I../lib -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GatewayServer.o src/GatewayServer.cpp
...
${OBJECTDIR}/src/baf.o: src/baf.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include/soci -I/usr/include/postgresql -I../lib -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/baf.o src/baf.cpp
