...
${OBJECTDIR}/src/CombinedTaskInstance.o: src/CombinedTaskInstance.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CombinedTaskInstance.o src/CombinedTaskInstance.cpp
...
${OBJECTDIR}/src/GatewayInterface.o: src/GatewayInterface.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GatewayInterface.o src/GatewayInterface.cpp
