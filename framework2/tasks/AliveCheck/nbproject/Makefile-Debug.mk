...
LDLIBSOPTIONS=-L/usr/local/lib64 -L/usr/lib/postgresql/9.3/lib -L../../../Notificator
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libAliveCheck.${CND_DLIB_EXT}: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libAliveCheck.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} -lsoci_core -lsoci_empty -lsoci_postgresql -ldl -lpq -lnotif -lcurl -shared -fPIC
